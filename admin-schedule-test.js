...
assert.ok(html.includes('EVERYTHING we create must be mobile-friendly'), 'standing rule is phone-first for all UI, not only grids');
...
assert.ok(html.includes('#tab_schedule .sched-scroll{max-width:100%;'), 'phone caps the week scroller to the schedule column');
assert.ok(!html.includes('#tab_schedule .sched-scroll{max-width:calc(100vw'), 'week scroller is not sized from 100vw');
