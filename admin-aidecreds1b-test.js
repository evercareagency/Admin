...
assert.ok(html.slice(buildAt, buildAt + 90).includes('content="2026-09-25-payready1"'), 'payready1 is the first admin-build meta');
...
async function runBrowser(){
  ...
  try{
    ...
    assert.strictEqual(empty.build, '2026-09-25-payready1');
