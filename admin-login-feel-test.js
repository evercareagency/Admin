...
assert.ok(html.includes('<meta name="admin-build" content="2026-09-24-sched1">'), 'nursespd1 admin-build after warmoff1');
...
async function runBrowser(){
  ...
  try{
    ...
    for(const vp of [
      ...
      assert.strictEqual(painted.build, '2026-09-24-sched1');
