...
assert.ok(html.includes('<meta name="admin-build" content="2026-09-24-sched1m">'), 'sched1m admin-build after warmoff1');
...
async function runBrowser(){
  ...
  try{
    ...
    for(const vp of [
      ...
      assert.strictEqual(painted.build, '2026-09-24-sched1m');
