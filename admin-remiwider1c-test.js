...
assert.ok(html.slice(buildAt, buildAt + 90).includes('2026-09-25-remiwider1c'), 'remiwider1c is the first admin-build meta');
...
async function runBrowser(){
  ...
  try{
    ...
    assert.strictEqual(gate.build, '2026-09-25-remiwider1c');
